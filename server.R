...
# and Publish, or
# go to ui.R, run, and hit the Publish button
...
shinyServer(function(input, output,session) {
    ...
    observeEvent(input$flat_examples, updateTextAreaInput(session, "ids", value="PGK1;PMA1;PAB1"))
    observeEvent(input$category_examples, updateTextAreaInput(session, "ids", value="glycolytic=PGK1,FBA1,TDH3; aggregator=pab1,xrn1,dcp2; superaggregator=ded1,nug1,ola1; ribosomal=RPL32,RPL4A,RPL19A,RPS9B,RPL21A; membrane=pma1,por1,srp61"))
