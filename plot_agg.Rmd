---
title: "Protein condensation during heat shock web tool"
author: "Edward W.J. Wallace, D. Allan Drummond"
date: "2024-10-31"
...
#the_string = "ribosomal=RPL32,RPL4A,RPL19A,RPS9B,RPL21A,RPS29B,RPL31A,RPL35A,RPL4B; glycolytic=GLK1,TDH3; agg=ded1, pab1; pma1; pgk1"
the_string = "glycolytic=PGK1,GLK1,TDH3; pab1; nug1; ded1; tif3; gus1; membrane=srp61,por1;"
splitstring(the_string)
#plot_from_input("PAB1,PGK1,PMA1", FALSE, "gene")
res = plot_from_input(the_string, FALSE, "gene")
ribgenes = unique(unlist(ps_dt |> filter(substring(gene, 1,3) %in% c('RPL','RPS')) |> select(gene)))
#rib2genes = setdiff(ribgenes, c('RPL23B','RPS14B','RPL38','RPL39','RPS27'))
#agggenes = c('PAB1','DED1','XRN1','DCP1','NUG1','OLA1')
#p = plotgenes_categories(list("ribosomal"=ribgenes, "aggregator"=agggenes), idType='gene', errorbars = TRUE)
#p$plot_temp
ggsave("agg-spectrum.pdf", 
       res$plot_time,
       width = 8,
       height = 8,
       units = "cm", bg = "transparent", create.dir=TRUE)
```