...
splitstring = function(s) {
  ...
  x = sapply(classes, function(ss) {
    ...
    genes=str_split(gsub("\\((.*)\\)", "\\1",res[2]),',')[[1]]
    g = list(g=genes)
    names(g)[1] = label
    print(g)
    g
...
splitstring = function(s) {
  # Take string formatted as "ribosomal=RPS1,RPS2; glycolytic=GLK1,TDH3" and split into a
  # list(ribosomal=('RPS1','RPS2'), glycolytic=c('GLK1','TDH3'))
  #if (T) {  s = "ribosomal=RPL32,RPL4A,RPL19A,RPS9B,RPL21A,RPS29B,RPL31A,RPL35A,RPL4B; glycolytic=GLK1,TDH3; agg=ded1,pab1; membrane = por1, pma1; pgk1" }
  classes = str_split(s,';')[[1]]
...
splitstring('ribosomal=rps1,RPS2; glycolytic=GLK1,TDH3; pma1; membrane=pma1, por1')
plot_from_input("PAB1,PGK1,PMA1", FALSE, "gene")
plot_from_input("ribosomal=rps1,RPS2; glycolytic=GLK1,TDH3; pma1", FALSE, "gene")
